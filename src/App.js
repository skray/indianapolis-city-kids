          ...
          <div style={styles.header}>
            ...
            <span style={{display: 'flex', 'flex-direction':'column', 'justify-content':'center'}}>
              <span style={{position: 'relative', width:`${flagWidth}px`, height: `${flagHeight}px`, display: 'flex'}}>
                ...
                <StarIcon style={{width: `${starDiameter}px`, height: `${starDiameter}px`, 'border-radius': '50%', 'color': cyan500, position: 'absolute', left: `${flagWidth/2 - starDiameter/2}px`, top: `${flagHeight/2 - starDiameter/2}px`}}/>
              </span>
            </span>
          </div>
